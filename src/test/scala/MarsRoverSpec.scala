...
//    val path = Pathfinder.shortestPath(GridSquare(1,1), GridSquare(2,4), (4,4))
...
//    val path = Pathfinder.shortestPath(GridSquare(1,1), GridSquare(2,3), (6,6))
//
//    path shouldBe List(
...
//  }
  ...
  it should "find a best path and make rover move" in {
    val path = Pathfinder.shortestPath(GridSquare(1,1), GridSquare(3,4), (4,4))
